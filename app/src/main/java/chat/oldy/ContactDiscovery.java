...
final class ContactDiscovery {
 ...
 static void show(MainActivity a){
  ...
  ScrollView scroll=new ScrollView(a);LinearLayout results=a.col();results.setTag("contacts-results");scroll.addView(results);a.root.addView(scroll,new LinearLayout.LayoutParams(-1,0,1));SettingsHome.navigation(a,1);
 }
