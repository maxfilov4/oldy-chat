...
final class ChannelHistory {
 ...
 static final String[] FIELDS={"kind","text","mime","size","name","sha256","sticker","reply","link","thumb","cloud_video","round","animated","cloud_blob","blob_key","blob_iv","duration","waveform","custom_sticker","sticker_id","sticker_author","op","mid","emoji"};
